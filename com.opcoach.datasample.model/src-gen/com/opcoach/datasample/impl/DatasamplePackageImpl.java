 ...
 * @generated
 */
public class DatasamplePackageImpl extends EPackageImpl implements DatasamplePackage
{
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see com.opcoach.datasample.DatasamplePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DatasamplePackageImpl()
	{
		super(eNS_URI, DatasampleFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link DatasamplePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DatasamplePackage init()
	{
		if (isInited) return (DatasamplePackage)EPackage.Registry.INSTANCE.getEPackage(DatasamplePackage.eNS_URI);

		// Obtain or create and register package
		DatasamplePackageImpl theDatasamplePackage = (DatasamplePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DatasamplePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DatasamplePackageImpl());
		...
		EPackage.Registry.INSTANCE.put(DatasamplePackage.eNS_URI, theDatasamplePackage);
	 ...
	 * @generated
	 */
	public DatasampleFactory getDatasampleFactory()
	{
		return (DatasampleFactory)getEFactoryInstance();
	}
