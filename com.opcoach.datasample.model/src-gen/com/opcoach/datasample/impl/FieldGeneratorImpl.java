 ...
 * <ul>
 *   <li>{@link com.opcoach.datasample.impl.FieldGeneratorImpl#getEntityName <em>Entity Name</em>}</li>
 *   <li>{@link com.opcoach.datasample.impl.FieldGeneratorImpl#getFieldName <em>Field Name</em>}</li>
 *   <li>{@link com.opcoach.datasample.impl.FieldGeneratorImpl#getGenerator <em>Generator</em>}</li>
 *   <li>{@link com.opcoach.datasample.impl.FieldGeneratorImpl#getStructuralFeature <em>Structural Feature</em>}</li>
 *   <li>{@link com.opcoach.datasample.impl.FieldGeneratorImpl#getErrorRate <em>Error Rate</em>}</li>
 *   <li>{@link com.opcoach.datasample.impl.FieldGeneratorImpl#getGeneratorName <em>Generator Name</em>}</li>
 *   <li>{@link com.opcoach.datasample.impl.FieldGeneratorImpl#getErrorGeneratorName <em>Error Generator Name</em>}</li>
 *   <li>{@link com.opcoach.datasample.impl.FieldGeneratorImpl#getErrorGenerator <em>Error Generator</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FieldGeneratorImpl extends MinimalEObjectImpl.Container implements FieldGenerator
{
	/**
	...
	{
		return DatasamplePackage.Literals.FIELD_GENERATOR;
	}
	...
	public void setEntityName(String newEntityName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatasamplePackage.FIELD_GENERATOR__ENTITY_NAME, oldEntityName, entityName));
	}
	...
	public void setFieldName(String newFieldName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatasamplePackage.FIELD_GENERATOR__FIELD_NAME, oldFieldName, fieldName));
	}
	...
	public ValueGenerator<?> getGenerator()
	{
		if (generator != null && generator.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DatasamplePackage.FIELD_GENERATOR__GENERATOR, oldGenerator, generator));
			}
		}
		return generator;
	}
	...
	public void setGenerator(ValueGenerator<?> newGenerator)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatasamplePackage.FIELD_GENERATOR__GENERATOR, oldGenerator, generator));
	}
	...
	public EStructuralFeature getStructuralFeature()
	{
		if (structuralFeature != null && structuralFeature.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DatasamplePackage.FIELD_GENERATOR__STRUCTURAL_FEATURE, oldStructuralFeature, structuralFeature));
			}
		}
	...
	public void setStructuralFeature(EStructuralFeature newStructuralFeature)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatasamplePackage.FIELD_GENERATOR__STRUCTURAL_FEATURE, oldStructuralFeature, structuralFeature));
	}
	...
	public void setErrorRate(int newErrorRate)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatasamplePackage.FIELD_GENERATOR__ERROR_RATE, oldErrorRate, errorRate));
	}
	...
	public void setGeneratorName(String newGeneratorName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatasamplePackage.FIELD_GENERATOR__GENERATOR_NAME, oldGeneratorName, generatorName));
	}
	...
	public void setErrorGeneratorName(String newErrorGeneratorName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatasamplePackage.FIELD_GENERATOR__ERROR_GENERATOR_NAME, oldErrorGeneratorName, errorGeneratorName));
	}
	...
	public ValueGenerator<?> getErrorGenerator()
	{
		if (errorGenerator != null && errorGenerator.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DatasamplePackage.FIELD_GENERATOR__ERROR_GENERATOR, oldErrorGenerator, errorGenerator));
			}
		}
	...
	public void setErrorGenerator(ValueGenerator<?> newErrorGenerator)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatasamplePackage.FIELD_GENERATOR__ERROR_GENERATOR, oldErrorGenerator, errorGenerator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case DatasamplePackage.FIELD_GENERATOR__FIELD_NAME:
				return getFieldName();
			case DatasamplePackage.FIELD_GENERATOR__GENERATOR:
				if (resolve) return getGenerator();
				return basicGetGenerator();
			case DatasamplePackage.FIELD_GENERATOR__STRUCTURAL_FEATURE:
			...
			case DatasamplePackage.FIELD_GENERATOR__ERROR_GENERATOR:
