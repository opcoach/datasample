...
public class DSGenClassItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DSGenClass_instanceNumber_feature", "_UI_DSGenClass_type"),
	...
	public String getText(Object object) {
		...
		return getString("_UI_DSGenClass_type") + " " + dsGenClass.getInstanceNumber();
	}
