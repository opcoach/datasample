 ...
 * @generated
 */
public class DSGenFeatureItemProvider
	extends DSGenTypedElementItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataSampleGenPackage.Literals.DS_GEN_FEATURE__NULLABLE_VALUE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_DSGenFeature_nullablePercent_feature", "_UI_DSGenFeature_type"),
				 DataSampleGenPackage.Literals.DS_GEN_FEATURE__NULLABLE_PERCENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DataSampleGenPackage.Literals.DS_GEN_FEATURE__ECORE_FEATURE,
				 true,
				 false,
				 true,
				 null,
