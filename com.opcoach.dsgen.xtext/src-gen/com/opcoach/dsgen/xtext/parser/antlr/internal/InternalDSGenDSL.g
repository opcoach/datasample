...
entryRuleDSGenModel returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSGenModelRule()); }
	 iv_ruleDSGenModel=ruleDSGenModel 
	 { $current=$iv_ruleDSGenModel.current; } 
	 EOF 
;

// Rule DSGenModel
ruleDSGenModel returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='DSGenModel' 
    {
...
entryRuleDSGenClassifier returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSGenClassifierRule()); }
	 iv_ruleDSGenClassifier=ruleDSGenClassifier 
	 { $current=$iv_ruleDSGenClassifier.current; } 
	 EOF 
;

// Rule DSGenClassifier
ruleDSGenClassifier returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_DSGenClass_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_DSGenDataType_Impl_1.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_DSGenEnum_2.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleValueGenerator returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getValueGeneratorRule()); }
	 iv_ruleValueGenerator=ruleValueGenerator 
	 { $current=$iv_ruleValueGenerator.current; } 
	 EOF 
;

// Rule ValueGenerator
ruleValueGenerator returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
    ...
    { 
        $current = $this_ReferenceGenerator_0.current; 
        afterParserOrEnumRuleCall();
    }
...
entryRuleDSGenFeature returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSGenFeatureRule()); }
	 iv_ruleDSGenFeature=ruleDSGenFeature 
	 { $current=$iv_ruleDSGenFeature.current; } 
	 EOF 
;

// Rule DSGenFeature
ruleDSGenFeature returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_DSGenFeature_Impl_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_DSGenAttribute_1.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_DSGenReference_2.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleDSGenPackage returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSGenPackageRule()); }
	 iv_ruleDSGenPackage=ruleDSGenPackage 
	 { $current=$iv_ruleDSGenPackage.current; } 
	 EOF 
;

// Rule DSGenPackage
ruleDSGenPackage returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='DSGenPackage' 
    {
...
entryRuleBadValueGeneratorRegistry returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getBadValueGeneratorRegistryRule()); }
	 ...
	 { $current=$iv_ruleBadValueGeneratorRegistry.current; } 
	 EOF 
;

// Rule BadValueGeneratorRegistry
ruleBadValueGeneratorRegistry returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
)	otherlv_1='BadValueGeneratorRegistry' 
    {
...
entryRuleDSGenFeature_Impl returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSGenFeature_ImplRule()); }
	 iv_ruleDSGenFeature_Impl=ruleDSGenFeature_Impl 
	 { $current=$iv_ruleDSGenFeature_Impl.current; } 
	 EOF 
;

// Rule DSGenFeature_Impl
ruleDSGenFeature_Impl returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='DSGenFeature' 
    {
...
entryRuleDSGenClass returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSGenClassRule()); }
	 iv_ruleDSGenClass=ruleDSGenClass 
	 { $current=$iv_ruleDSGenClass.current; } 
	 EOF 
;

// Rule DSGenClass
ruleDSGenClass returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='DSGenClass' 
    {
...
entryRuleDSGenDataType_Impl returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSGenDataType_ImplRule()); }
	 iv_ruleDSGenDataType_Impl=ruleDSGenDataType_Impl 
	 { $current=$iv_ruleDSGenDataType_Impl.current; } 
	 EOF 
;

// Rule DSGenDataType_Impl
ruleDSGenDataType_Impl returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='DSGenDataType' 
    {
...
entryRuleDSGenEnum returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSGenEnumRule()); }
	 iv_ruleDSGenEnum=ruleDSGenEnum 
	 { $current=$iv_ruleDSGenEnum.current; } 
	 EOF 
;

// Rule DSGenEnum
ruleDSGenEnum returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='DSGenEnum' 
...
entryRuleDSGenAttribute returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSGenAttributeRule()); }
	 iv_ruleDSGenAttribute=ruleDSGenAttribute 
	 { $current=$iv_ruleDSGenAttribute.current; } 
	 EOF 
;

// Rule DSGenAttribute
ruleDSGenAttribute returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='DSGenAttribute' 
    {
...
entryRuleDSGenReference returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDSGenReferenceRule()); }
	 iv_ruleDSGenReference=ruleDSGenReference 
	 { $current=$iv_ruleDSGenReference.current; } 
	 EOF 
;

// Rule DSGenReference
ruleDSGenReference returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='DSGenReference' 
    {
...
entryRuleReferenceGenerator returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getReferenceGeneratorRule()); }
	 iv_ruleReferenceGenerator=ruleReferenceGenerator 
	 { $current=$iv_ruleReferenceGenerator.current; } 
	 EOF 
;

// Rule ReferenceGenerator
ruleReferenceGenerator returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleEObjectGenerator returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getEObjectGeneratorRule()); }
	 iv_ruleEObjectGenerator=ruleEObjectGenerator 
	 { $current=$iv_ruleEObjectGenerator.current; } 
	 EOF 
;

// Rule EObjectGenerator
ruleEObjectGenerator returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
