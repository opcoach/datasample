 ...
 * @generated
 */
public class DataSampleGenSwitch<T> extends Switch<T>
{
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		...
		case DataSampleGenPackage.DS_GEN_MODEL:
		{
			...
			if (result == null)
				result = caseDSGenBase(dsGenModel);
			if (result == null)
		...
		case DataSampleGenPackage.DS_GEN_PACKAGE:
		{
			...
			if (result == null)
				result = caseDSGenBase(dsGenPackage);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataSampleGenPackage.DS_GEN_CLASS:
		{
			...
			if (result == null)
				result = caseDSGenClassifier(dsGenClass);
			if (result == null)
				result = caseDSGenBase(dsGenClass);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataSampleGenPackage.DS_GEN_FEATURE:
		{
			...
			if (result == null)
				result = caseDSGenTypedElement(dsGenFeature);
			if (result == null)
				result = caseDSGenBase(dsGenFeature);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case DataSampleGenPackage.DS_GEN_ENUM_LITERAL:
		{
			...
			if (result == null)
				result = caseDSGenBase(dsGenEnumLiteral);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataSampleGenPackage.DS_GEN_CLASSIFIER:
		{
			...
			if (result == null)
				result = caseDSGenBase(dsGenClassifier);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataSampleGenPackage.DS_GEN_DATA_TYPE:
		{
			...
			if (result == null)
				result = caseDSGenClassifier(dsGenDataType);
			if (result == null)
				result = caseDSGenBase(dsGenDataType);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataSampleGenPackage.DS_GEN_TYPED_ELEMENT:
		{
			...
			if (result == null)
				result = caseDSGenBase(dsGenTypedElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataSampleGenPackage.DS_GEN_ANNOTATION:
		{
			...
			if (result == null)
				result = caseDSGenBase(dsGenAnnotation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataSampleGenPackage.DS_GEN_TYPE_PARAMETER:
		{
			...
			if (result == null)
				result = caseDSGenBase(dsGenTypeParameter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataSampleGenPackage.DS_GEN_ATTRIBUTE:
		{
			...
			if (result == null)
				result = caseDSGenFeature(dsGenAttribute);
			if (result == null)
				result = caseDSGenTypedElement(dsGenAttribute);
			if (result == null)
				result = caseDSGenBase(dsGenAttribute);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataSampleGenPackage.DS_GEN_REFERENCE:
		{
			...
			if (result == null)
				result = caseDSGenFeature(dsGenReference);
			if (result == null)
				result = caseDSGenTypedElement(dsGenReference);
			if (result == null)
				result = caseDSGenBase(dsGenReference);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataSampleGenPackage.DS_GEN_ENUM:
		{
			...
			if (result == null)
				result = caseDSGenDataType(dsGenEnum);
			if (result == null)
				result = caseDSGenClassifier(dsGenEnum);
			if (result == null)
				result = caseDSGenBase(dsGenEnum);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
