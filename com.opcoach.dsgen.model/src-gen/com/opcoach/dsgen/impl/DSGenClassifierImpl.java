 ...
 * <ul>
 *   <li>{@link com.opcoach.dsgen.impl.DSGenClassifierImpl#getEcoreClass <em>Ecore Class</em>}</li>
 *   <li>{@link com.opcoach.dsgen.impl.DSGenClassifierImpl#getDsgenFeatures <em>Dsgen Features</em>}</li>
 *   <li>{@link com.opcoach.dsgen.impl.DSGenClassifierImpl#getDsgenPackage <em>Dsgen Package</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DSGenClassifierImpl extends DSGenBaseImpl implements DSGenClassifier
{
		...
		if (ecoreClass != null && ecoreClass.eIsProxy())
		{
			...
			if (ecoreClass != oldEcoreClass)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataSampleGenPackage.DS_GEN_CLASSIFIER__ECORE_CLASS,
	...
	public void setEcoreClass(EClass newEcoreClass)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataSampleGenPackage.DS_GEN_CLASSIFIER__ECORE_CLASS,
					oldEcoreClass, ecoreClass));
	}
	...
	public EList<DSGenFeature> getDsgenFeatures()
	{
		...
		{
			dsgenFeatures = new EObjectContainmentWithInverseEList<DSGenFeature>(DSGenFeature.class, this,
					DataSampleGenPackage.DS_GEN_CLASSIFIER__DSGEN_FEATURES, DataSampleGenPackage.DS_GEN_FEATURE__DSGEN_CLASS);
		}
	...
	{
		if (newDsgenPackage != eInternalContainer()
				|| (eContainerFeatureID() != DataSampleGenPackage.DS_GEN_CLASSIFIER__DSGEN_PACKAGE && newDsgenPackage != null))
		{
			...
			if (newDsgenPackage != null)
				msgs = ((InternalEObject) newDsgenPackage).eInverseAdd(this,
						DataSampleGenPackage.DS_GEN_PACKAGE__DSGEN_CLASSIFIERS, DSGenPackage.class, msgs);
			msgs = basicSetDsgenPackage(newDsgenPackage, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataSampleGenPackage.DS_GEN_CLASSIFIER__DSGEN_PACKAGE,
					newDsgenPackage, newDsgenPackage));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
		case DataSampleGenPackage.DS_GEN_CLASSIFIER__DSGEN_PACKAGE:
			return eInternalContainer().eInverseRemove(this, DataSampleGenPackage.DS_GEN_PACKAGE__DSGEN_CLASSIFIERS,
					DSGenPackage.class, msgs);
		}
