	...
	public NotificationChain basicSetGenerator(ValueGenerator<?> newGenerator, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DataSampleGenPackage.DS_GEN_ATTRIBUTE__GENERATOR, oldGenerator, newGenerator);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newGenerator != generator)
		{
			...
			if (generator != null)
				msgs = ((InternalEObject) generator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- DataSampleGenPackage.DS_GEN_ATTRIBUTE__GENERATOR, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DataSampleGenPackage.DS_GEN_ATTRIBUTE__GENERATOR, newGenerator,
					newGenerator));
	}
