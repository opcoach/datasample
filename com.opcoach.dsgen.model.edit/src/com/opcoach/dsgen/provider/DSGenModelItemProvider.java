 ...
 * @generated
 */
public class DSGenModelItemProvider extends DSGenBaseItemProvider implements IEditingDomainItemProvider,
		IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemFontProvider
{
	 ...
	 * @generated
	 */
	public DSGenModelItemProvider(AdapterFactory adapterFactory)
	{
	...
	protected void addRandomSeedPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_DSGenModel_randomSeed_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_DSGenModel_randomSeed_feature", "_UI_DSGenModel_type"),
				DataSampleGenPackage.Literals.DS_GEN_MODEL__RANDOM_SEED, true, false, false,
	...
	protected void addNamePropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DSGenModel_name_feature"),
	...
	/**
	 * This returns DSGenModel.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DSGenModel"));
	}
	...
	{
		String label = ((DSGenModel) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_DSGenModel_type") : getString("_UI_DSGenModel_type") + " "
				+ label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(DSGenModel.class))
		{
